                ...
                if abs(ptc_gen1.p.pz) / ptc_gen1.p.absvalue() <= math.cos(math.pi / 12):
                    ...
                    if pb > 25.: # select only events with large momentum of the B
                        ...
                        if pvsv_distance > 1.: # select only events with long flight distance of the B
                            ...
                            if b is not None and kstar is not None and k is not None and pi_kstar is not None and tau is not None and pi1_tau is not None and pi2_tau is not None and pi3_tau is not None and nu_tau is not None and nu is not None and d is not None and tau_d is not None and pi1_tau_d is not None and pi2_tau_d is not None and pi3_tau_d is not None and nu_tau_d is not None and nu_d is not None:
