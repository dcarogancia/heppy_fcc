...
class BsDsstDsstXKKPiAnalyzer(Analyzer):
    def beginLoop(self, setup):
        ...
        #self.rootfile = TFile('/'.join([self.dirName, 'Bs_DsstDsstX_KKpi_bkg_evtpdl2019_0.5mmBfdcut-86.9k.root']), 'recreate')
        self.rootfile = TFile('/'.join([self.dirName, 'Bs_DsstDsstX_KKpi_bkg_evtpdl2019-86.9k.root']), 'recreate')
            ...
            if (abs(ptc_gen.pdgid) == 531 and ptc_gen.start_vertex != ptc_gen.end_vertex):
                ...
                for ptc_gen1 in ptcs:   
                    ...
                    if (ptc_gen1.start_vertex == sv_mctruth and ptc_gen1.start_vertex != ptc_gen1.end_vertex):
                        ...
                        if abs(ptc_gen1.pdgid) not in [431,531]:
                ...
                #if len(plist_Bs_Ds) == 1 and len(plist_Bd_D) == 1 and len(plist_Bd_D2) == 0:
                #if len(plist_Bs_Ds) == 2:
                if len(plist_Bs_Ds) == 2 and self.DsDs_counter < 86900:
                    
                    self.DsDs_counter += 1
                    
                    Bs_Ds1_En = plist_Bs_Ds[0].energy
                    Bs_Ds1_px = plist_Bs_Ds[0].p.px
                    Bs_Ds1_py = plist_Bs_Ds[0].p.py
                    Bs_Ds1_pz = plist_Bs_Ds[0].p.pz
                    Bs_Ds1_p = plist_Bs_Ds[0].p.absvalue()
                    
                    Bs_Ds2_En = plist_Bs_Ds[1].energy
                    Bs_Ds2_px = plist_Bs_Ds[1].p.px
                    Bs_Ds2_py = plist_Bs_Ds[1].p.py
                    Bs_Ds2_pz = plist_Bs_Ds[1].p.pz
                    Bs_Ds2_p = plist_Bs_Ds[1].p.absvalue()
                    
                    Bs_Ds1 = copy.deepcopy(plist_Bs_Ds[0])
                    Bs_Ds2 = copy.deepcopy(plist_Bs_Ds[1])
                    
                    Bs_Ds1_pT = np.sqrt(plist_Bs_Ds[0].p.px**2 + plist_Bs_Ds[0].p.py**2)
                    Bs_Ds2_pT = np.sqrt(plist_Bs_Ds[1].p.px**2 + plist_Bs_Ds[1].p.py**2)
                    
                    Bs_Ds1_presol = momentum_res(Bs_Ds1_pT)
                    Bs_Ds2_presol = momentum_res(Bs_Ds2_pT)
                    
                    if self.cfg_ana.smear_momentum:
                        Bs_Ds1.p = smear_momentum(Bs_Ds1.p, Bs_Ds1_presol, Bs_Ds1_presol, Bs_Ds1_presol)
                        Bs_Ds2.p = smear_momentum(Bs_Ds2.p, Bs_Ds2_presol, Bs_Ds2_presol, Bs_Ds2_presol)  
                        
                    Bs_pt = np.dot([Bs_Ds1_px + Bs_Ds2_px + Bd_X_px, Bs_Ds1_py + Bs_Ds2_py + Bd_X_py, Bs_Ds1_pz + Bs_Ds2_pz + Bd_X_pz],[Bs_Ds1_px + Bs_Ds2_px + Bd_X_px, Bs_Ds1_py + Bs_Ds2_py + Bd_X_py, Bs_Ds1_pz + Bs_Ds2_pz + Bd_X_pz])                    
                    
                    Bs_mass = np.sqrt((Bs_Ds1_En + Bs_Ds2_En + Bd_X_Et)**2 - Bs_pt)                                     
                    
                    Bs_spt = np.dot([Bs_Ds1.p.px + Bs_Ds2.p.px + Bd_X_spx, Bs_Ds1.p.py + Bs_Ds2.p.py + Bd_X_spy, Bs_Ds1.p.pz + Bs_Ds2.p.pz + Bd_X_spz],[Bs_Ds1.p.px + Bs_Ds2.p.px + Bd_X_spx, Bs_Ds1.p.py + Bs_Ds2.p.py + Bd_X_spy, Bs_Ds1.p.pz + Bs_Ds2.p.pz + Bd_X_spz])
                    
                    Bs_Ds1_sEn = np.sqrt(Bs_Ds1.p.absvalue()**2 + Bs_Ds1.mass**2)
                    
                    Bs_Ds2_sEn = np.sqrt(Bs_Ds2.p.absvalue()**2 + Bs_Ds2.mass**2)
                
                    Bs_smass = np.sqrt((Bs_Ds1_sEn + Bs_Ds2_sEn + Bd_X_sEt)**2 - Bs_spt)
                    
                    #print plist_Bs_Ds[0].p.absvalue(), Bs_Ds1.p.absvalue(), np.sqrt(np.dot([Bs_Ds1.p.px, Bs_Ds1.p.py, Bs_Ds1.p.pz],[Bs_Ds1.p.px, Bs_Ds1.p.py, Bs_Ds1.p.pz]))
                                
                    #if Bs_smass > 5.5:
                    #    print 'Mass', Bs_mass, Bs_smass, Bd_X_sEt, plist_Bd[0].p.absvalue()
                    
                    for ptc_gen3 in ptcs:
                        
                        if abs(ptc_gen3.pdgid) == 13 and ((ptc_gen3.start_vertex == plist_Bs_Ds[0].end_vertex) or (ptc_gen3.start_vertex == plist_Bs_Ds[1].end_vertex)):
                                #plist_Ds_KKpi.append(ptc_gen2)
                                plist_Ds_mu.append(ptc_gen3)                                
                                self.mu_counter += 1
                                        
                    for ptc_gen2 in ptcs:
                                                                       
                        if abs(ptc_gen2.pdgid) == 321 and (ptc_gen2.start_vertex != plist_Ds_mu[0].start_vertex) and ((ptc_gen2.start_vertex == plist_Bs_Ds[0].end_vertex) or (ptc_gen2.start_vertex == plist_Bs_Ds[1].end_vertex)):
                                plist_Ds_KK.append(ptc_gen2)
                                self.DsKK_counter += 1
                                
                        if abs(ptc_gen2.pdgid) == 211 and (ptc_gen2.start_vertex != plist_Ds_mu[0].start_vertex) and ((ptc_gen2.start_vertex == plist_Bs_Ds[0].end_vertex) or (ptc_gen2.start_vertex == plist_Bs_Ds[1].end_vertex)):
                                plist_Ds_pi.append(ptc_gen2)
                                self.Dspi_counter += 1
                         
                        if (ptc_gen2.start_vertex != ptc_gen2.end_vertex) and (ptc_gen2.start_vertex == plist_Bs_Ds[0].end_vertex or ptc_gen2.start_vertex == plist_Bs_Ds[1].end_vertex):
                            ...
                            if abs(ptc_gen2.pdgid) not in [13,12,14,16,321,211,531]:
                    ...
                    #if len(plist_Ds_mu) == 1 and len(plist_Ds_KK) == 2 and len(plist_Ds_pi) == 1:
                    #    self.KKpimu_counter += 1
                
                    D_X_pt = np.dot([D_X_px, D_X_py, D_X_pz],[D_X_px, D_X_py, D_X_pz])
                    #D_X_mass = np.sqrt(D_X_Et**2 - D_X_pt) 
                    
                    Ds_K1_px, Ds_K1_py, Ds_K1_pz = plist_Ds_KK[0].p.px, plist_Ds_KK[0].p.py, plist_Ds_KK[0].p.pz
                    Ds_K2_px, Ds_K2_py, Ds_K2_pz = plist_Ds_KK[1].p.px, plist_Ds_KK[1].p.py, plist_Ds_KK[1].p.pz
                    Ds_pi_px, Ds_pi_py, Ds_pi_pz = plist_Ds_pi[0].p.px, plist_Ds_pi[0].p.py, plist_Ds_pi[0].p.pz
                    D_mu_px, D_mu_py, D_mu_pz = plist_Ds_mu[0].p.px, plist_Ds_mu[0].p.py, plist_Ds_mu[0].p.pz
                    
                    Ds_K1_p, Ds_K2_p, Ds_pi_p, D_mu_p = plist_Ds_KK[0].p.absvalue(), plist_Ds_KK[0].p.absvalue(), plist_Ds_KK[0].p.absvalue(), plist_Ds_mu[0].p.absvalue()
                    
                    Ds_K1_En, Ds_K2_En, Ds_pi_En, D_mu_En = plist_Ds_KK[0].energy, plist_Ds_KK[1].energy, plist_Ds_pi[0].energy, plist_Ds_mu[0].energy
                                        
                    Ds_KKpimu_En = Ds_K1_En + Ds_K2_En + Ds_pi_En + D_mu_En
                
                    #Bd_KKpimu_pt = np.dot([plist_Ds_KK[0].p.px + plist_Ds_KK[1].p.px + plist_Ds_pi[0].p.px + plist_Ds_mu[0].p.px + Bd_X_px, plist_Ds_KK[0].p.py + plist_Ds_KK[1].p.py + plist_Ds_pi[0].p.py + plist_Ds_mu[0].p.py + Bd_X_py, plist_Ds_KK[0].p.pz + plist_Ds_KK[1].p.pz + plist_Ds_pi[0].p.pz + plist_Ds_mu[0].p.pz + Bd_X_pz],[plist_Ds_KK[0].p.px + plist_Ds_KK[1].p.px + plist_Ds_pi[0].p.px + plist_Ds_mu[0].p.px + Bd_X_px, plist_Ds_KK[0].p.py + plist_Ds_KK[1].p.py + plist_Ds_pi[0].p.py + plist_Ds_mu[0].p.py + Bd_X_py, plist_Ds_KK[0].p.pz + plist_Ds_KK[1].p.pz + plist_Ds_pi[0].p.pz + plist_Ds_mu[0].p.pz + Bd_X_pz])
                    ...
                    #Bd_KKpimu_pt = np.dot([plist_Ds_KK[0].p.px + plist_Ds_KK[1].p.px + plist_Ds_pi[0].p.px + plist_Ds_mu[0].p.px + D_X_px, plist_Ds_KK[0].p.py + plist_Ds_KK[1].p.py + plist_Ds_pi[0].p.py + plist_Ds_mu[0].p.py + D_X_py, plist_Ds_KK[0].p.pz + plist_Ds_KK[1].p.pz + plist_Ds_pi[0].p.pz + plist_Ds_mu[0].p.pz + D_X_pz],[plist_Ds_KK[0].p.px + plist_Ds_KK[1].p.px + plist_Ds_pi[0].p.px + plist_Ds_mu[0].p.px + D_X_px, plist_Ds_KK[0].p.py + plist_Ds_KK[1].p.py + plist_Ds_pi[0].p.py + plist_Ds_mu[0].p.py + D_X_py, plist_Ds_KK[0].p.pz + plist_Ds_KK[1].p.pz + plist_Ds_pi[0].p.pz + plist_Ds_mu[0].p.pz + D_X_pz])
                    ...
                    Bd_KKpimu_mass = np.sqrt((Ds_KKpimu_En)**2 - Bd_KKpimu_pt)
                    #Bd_KKpimu_mass = np.sqrt((Ds_KKpimu_En + Bd_X_Et)**2 - Bd_KKpimu_pt)
                    #Bd_KKpimu_mass = np.sqrt((Ds_KKpimu_En + D_X_Et)**2 - Bd_KKpimu_pt)
                                        
                    Bd_KKpimuX_mass = np.sqrt((Ds_KKpimu_En + Bd_X_Et + D_X_Et)**2 - Bd_KKpimuX_pt)
                    
                    Ds_K1 = copy.deepcopy(plist_Ds_KK[0])
                    Ds_K2 = copy.deepcopy(plist_Ds_KK[1])
                    Ds_pi = copy.deepcopy(plist_Ds_pi[0])
                    D_mu  = copy.deepcopy(plist_Ds_mu[0])
                    
                    Ds_K1_pT = np.sqrt(plist_Ds_KK[0].p.px**2 + plist_Ds_KK[0].p.py**2)
                    Ds_K2_pT = np.sqrt(plist_Ds_KK[1].p.px**2 + plist_Ds_KK[1].p.py**2)
                    Ds_pi_pT = np.sqrt(plist_Ds_pi[0].p.px**2 + plist_Ds_pi[0].p.py**2)
                    D_mu_pT  = np.sqrt(plist_Ds_mu[0].p.px**2 + plist_Ds_mu[0].p.py**2)
                    ...
                    Bd_KKpimuX_spt = np.dot([Ds_K1_spx + Ds_K2_spx + Ds_pi_spx + D_mu_spx + Bd_X_spx + D_X_spx, Ds_K1_spy + Ds_K2_spy + Ds_pi_spy + D_mu_spy + Bd_X_spy + D_X_spy, Ds_K1_spz + Ds_K2_spz + Ds_pi_spz + D_mu_spz + Bd_X_spz + D_X_spz],[Ds_K1_spx + Ds_K2_spx + Ds_pi_spx + D_mu_spx + Bd_X_spx + D_X_spx, Ds_K1_spy + Ds_K2_spy + Ds_pi_spy + D_mu_spy + Bd_X_spy + D_X_spy, Ds_K1_spz + Ds_K2_spz + Ds_pi_spz + D_mu_spz + Bd_X_spz + D_X_spz])
                    
                    #Bd_KKpimuX_spt = np.dot([Ds_K1.p.px + Ds_K2.p.px + Ds_pi.p.px + D_mu.p.px, Ds_K1.p.py + Ds_K2.p.py + Ds_pi.p.py + D_mu.p.py, Ds_K1.p.pz + Ds_K2.p.pz + Ds_pi.p.pz + D_mu.p.pz],[Ds_K1.p.px + Ds_K2.p.px + Ds_pi.p.px + D_mu.p.px, Ds_K1.p.py + Ds_K2.p.py + Ds_pi.p.py + D_mu.p.py, Ds_K1.p.pz + Ds_K2.p.pz + Ds_pi.p.pz + D_mu.p.pz])

                    #Bd_KKpimu_smass = np.sqrt((Ds_KKpimu_sEn + Bd_X_sEt)**2 - Bd_KKpimu_spt)
                    Bd_KKpimu_smass = np.sqrt((Ds_KKpimu_sEn)**2 - Bd_KKpimu_spt)
                    
                    Bd_KKpimuX_smass = np.sqrt((Ds_KKpimu_sEn + Bd_X_sEt + D_X_sEt)**2 - Bd_KKpimuX_spt)
                    ...
                    KKpimu_spar = np.dot([sv.x - pv.x, sv.y - pv.y, sv.z - pv.z],[Ds_K1_spx + Ds_K2_spx + Ds_pi_spx + D_mu_spx, Ds_K1_spy + Ds_K2_spy + Ds_pi_spy + D_mu_spy, Ds_K1_spz + Ds_K2_spz + Ds_pi_spz + D_mu_spz])/Bd_sfd

                    KKpimu_spTmis = np.dot([(Ds_K1_spx + Ds_K2_spx + Ds_pi_spx + D_mu_spx) - KKpimu_spar*(sv.x - pv.x)/Bd_sfd, (Ds_K1_spy + Ds_K2_spy + Ds_pi_spy + D_mu_spy) - KKpimu_spar*(sv.y - pv.y)/Bd_sfd, (Ds_K1_spz + Ds_K2_spz + Ds_pi_spz + D_mu_spz) - KKpimu_spar*(sv.z - pv.z)/Bd_sfd],[(Ds_K1_spx + Ds_K2_spx + Ds_pi_spx + D_mu_spx) - KKpimu_spar*(sv.x - pv.x)/Bd_sfd, (Ds_K1_spy + Ds_K2_spy + Ds_pi_spy + D_mu_spy) - KKpimu_spar*(sv.y - pv.y)/Bd_sfd, (Ds_K1_spz + Ds_K2_spz + Ds_pi_spz + D_mu_spz) - KKpimu_spar*(sv.z - pv.z)/Bd_sfd])
                            
                    Bd_KKpimu_smcorr = np.sqrt(Bd_KKpimu_smass**2 + KKpimu_spTmis) + np.sqrt(KKpimu_spTmis)
                    
                    pv_Ds_mctruth = Bs_Ds1.start_vertex
                    sv_Ds_mctruth = Bs_Ds1.end_vertex
                    ...
                    Bd_Dsmu_vtx.setDaughter(1, D_mu.charge, np.array([D_mu.p.px, D_mu.p.py, D_mu.p.pz]), 0.1*np.array([pv_mu.x, pv_mu.y, pv_mu.z]), covmat_mu)
                    ...
                    self.mc_truth_tree.fill('B_Ds_En',          Bs_Ds1_En)
                    self.mc_truth_tree.fill('B_Ds_px',          Bs_Ds1.p.px)                            
                    self.mc_truth_tree.fill('B_Ds_py',          Bs_Ds1.p.py)
                    self.mc_truth_tree.fill('B_Ds_pz',          Bs_Ds1.p.pz)
                    self.mc_truth_tree.fill('B_Ds_p',           Bs_Ds1.p.absvalue())
                    ...
                    self.smeared_tree.fill('B_Ds_sEn',           Bs_Ds1_sEn)
                    self.smeared_tree.fill('B_Ds_spx',           Bs_Ds1.p.px)                            
                    self.smeared_tree.fill('B_Ds_spy',           Bs_Ds1.p.py)
                    self.smeared_tree.fill('B_Ds_spz',           Bs_Ds1.p.pz)
                    self.smeared_tree.fill('B_Ds_sp',            Bs_Ds1.p.absvalue())                    
    ...
    def write(self, unusefulVar):
        ...
        print('Ds(+/-)DsD(+/-) meson events: {}'.format(self.DsDs_counter))   
        print('KK from Ds meson: {}'.format(self.DsKK_counter))
        print('pions from Ds meson: {}'.format(self.Dspi_counter))
        print('KKpimu events: {}'.format(self.KKpimu_counter))
