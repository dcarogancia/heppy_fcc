...
"""
    Analyzer of B0s -> pi+ Ds- events (special for Stephane)
                           |-> K- K+ pi-
...
class SpecialBs2DsPiWithDs2KKPiAnalyzer(Analyzer):
    """
        Analyzer of B0s -> pi+ Ds- background events (special for Stephane)
                                |-> K- K+ pi-
    ...
    def __init__(self, cfg_ana, cfg_comp, looper_name):
        ...
        super(SpecialBs2DsPiWithDs2KKPiAnalyzer, self).__init__(cfg_ana, cfg_comp, looper_name)
    ...
    def beginLoop(self, setup):
        ...
        super(SpecialBs2DsPiWithDs2KKPiAnalyzer, self).beginLoop(setup)
