                ...
                if abs(ptc_gen1.p.pz) / ptc_gen1.p.absvalue() <= math.cos(math.pi / 12):
                    ...
                    if pb > 25.: # Select only events with large momentum of the B
                        ...
                        if pvsv_distance > 1.: # Select only events with long flight distance of the B
                            ...
                            if b is not None and kstar is not None and k is not None and pi_kstar is not None and dplus is not None and dminus is not None and pi1_dplus is not None and pi2_dplus is not None and pi3_dplus is not None and k0_dplus is not None and pi1_dminus is not None and pi2_dminus is not None and pi3_dminus is not None and k0_dminus is not None:
