...
class BplusDstMuNuXKPiPiAnalyzer(Analyzer):
    def beginLoop(self, setup):
        ...
        super(BplusDstMuNuXKPiPiAnalyzer, self).beginLoop(setup)
        #self.rootfile = TFile('/'.join([self.dirName, 'Bd2DmunuKpipi-100k.root']), 'recreate')
        
        self.rootfile = TFile('/'.join([self.dirName, 'Bplus_DstmunuX_Kpipi_signal_evtpdl2019-1M.root']), 'recreate')
        ...
        self.smeared_tree.var('Dst_Kpipi_smass')
        self.smeared_tree.var('Dst_Kpipi_spT')
        self.smeared_tree.var('Dst_Kpipi_spT_FdB')
    ...
    def process(self, event):
        ...
        for ptc_gen in ptcs:
            ...
            if (abs(ptc_gen.pdgid) == 521 and ptc_gen.start_vertex != ptc_gen.end_vertex):
                ...
                for ptc_gen1 in ptcs:   
                    ...
                    if (ptc_gen1.start_vertex == sv_mctruth):
                        ...
                        #Looking for D0
                        if abs(ptc_gen1.pdgid) == 413:
                            plist_Bd_Dst.append(ptc_gen1)   
                            self.Dst_counter += 1
                            
                        if abs(ptc_gen1.pdgid) == 421:
                            plist_Bd_D0.append(ptc_gen1)   
                            self.Bd_D0_counter += 1
                        ...
                        if ((abs(ptc_gen1.pdgid) not in [13,12,14,15,16,211,421,511]) and (ptc_gen1.status == 1)) :
                ...
                #if len(plist_Bd_pi) != 0: 
                #print plist_Bd_pi[0].pdgid
                
                #if len(plist_Bd_Dst) == 1 and len(plist_Bd_mu) == 1 and len(plist_Bs_D2) == 0:
                if len(plist_Bd_Dst) == 1 and len(plist_Bd_mu) == 1 and self.Bd_Dstmu_counter < 1000000:
                #if len(plist_Bd_Dst) == 1 and len(plist_Bd_mu) == 1 and Bd_fd > 0.5 and self.Bd_Dstmu_counter < 1000000:
                    
                    self.Bd_Dstmu_counter += 1
                    
                    Bd_D_En = plist_Bd_Dst[0].energy
                    Bd_D_px = plist_Bd_Dst[0].p.px
                    Bd_D_py = plist_Bd_Dst[0].p.py
                    Bd_D_pz = plist_Bd_Dst[0].p.pz
                    Bd_D_p = plist_Bd_Dst[0].p.absvalue()
        
                    Bd_D = copy.deepcopy(plist_Bd_Dst[0])
                    Bd_mu = copy.deepcopy(plist_Bd_mu[0])
                    Bd_pi = copy.deepcopy(plist_Bd_pi[0])                    
                    
        
                    Bd_D_pT = np.sqrt(plist_Bd_Dst[0].p.px**2 + plist_Bd_Dst[0].p.py**2)
                    ...
                    #Bd_pt = np.dot([plist_Bd_Dst[0].p.px + plist_Bd_mu[0].p.px + Bd_X_px, plist_Bd_Dst[0].p.py + plist_Bd_mu[0].p.py + Bd_X_py, plist_Bd_Dst[0].p.pz + plist_Bd_mu[0].p.pz + Bd_X_pz],[plist_Bd_Dst[0].p.px + plist_Bd_mu[0].p.px + Bd_X_px, plist_Bd_Dst[0].p.py + plist_Bd_mu[0].p.py + Bd_X_py, plist_Bd_Dst[0].p.pz + plist_Bd_mu[0].p.pz + Bd_X_pz])
                    
                    Bd_pt = np.dot([plist_Bd_Dst[0].p.px + plist_Bd_mu[0].p.px + plist_Bd_pi[0].p.px, plist_Bd_Dst[0].p.py + plist_Bd_mu[0].p.py + plist_Bd_pi[0].p.py, plist_Bd_Dst[0].p.pz + plist_Bd_mu[0].p.pz + plist_Bd_pi[0].p.pz],[plist_Bd_Dst[0].p.px + plist_Bd_mu[0].p.px + plist_Bd_pi[0].p.px, plist_Bd_Dst[0].p.py + plist_Bd_mu[0].p.py + plist_Bd_pi[0].p.py, plist_Bd_Dst[0].p.pz + plist_Bd_mu[0].p.pz + plist_Bd_pi[0].p.pz])
                    
                    
                    Bd_mass = np.sqrt((Bd_D_En + plist_Bd_mu[0].energy + plist_Bd_pi[0].energy)**2 - Bd_pt)                                     
                    
                    Bd_spt = np.dot([Bd_D.p.px + Bd_mu.p.px + Bd_pi.p.px, Bd_D.p.py + Bd_mu.p.py + Bd_pi.p.py, Bd_D.p.pz + Bd_mu.p.pz + Bd_pi.p.pz],[Bd_D.p.px + Bd_mu.p.px + Bd_pi.p.px, Bd_D.p.py + Bd_mu.p.py + Bd_pi.p.py, Bd_D.p.pz + Bd_mu.p.pz + Bd_pi.p.pz])
                    ...
                    Bd_smass = np.sqrt((Bd_D_sEn + Bd_mu_sEn + Bd_pi_sEn)**2 - Bd_spt)
                    
                    #print plist_Bd_Dst[0].p.absvalue(), Bd_D.p.absvalue(), np.sqrt(np.dot([Bd_D.p.px, Bd_D.p.py, Bd_D.p.pz],[Bd_D.p.px, Bd_D.p.py, Bd_D.p.pz]))
                    ...
                    #print 'D0 daughters ' , len(plist_Dst_D0), plist_Dst_D0[0].pdgid, plist_Dst_D0[1].pdgid
                    #print 'D daughters status ' , plist_Dst_D0[0].status, plist_Dst_D0[1].status, plist_Dst_D0[2].status
        
                    D_K_px, D_K_py, D_K_pz = plist_Dst_D0[0].p.px, plist_Dst_D0[0].p.py, plist_Dst_D0[0].p.pz
                    D_pi1_px, D_pi1_py, D_pi1_pz = plist_Dst_D0[1].p.px, plist_Dst_D0[1].p.py, plist_Dst_D0[1].p.pz
                    D_pi2_px, D_pi2_py, D_pi2_pz = plist_Bd_pi[1].p.px, plist_Bd_pi[1].p.py, plist_Bd_pi[1].p.pz
                    D_mu_px, D_mu_py, D_mu_pz = plist_Bd_mu[0].p.px, plist_Bd_mu[0].p.py, plist_Bd_mu[0].p.pz
                    
                    D_K_p, D_pi1_p, D_pi2_p, D_mu_p = plist_Dst_D0[0].p.absvalue(), plist_Dst_D0[1].p.absvalue(), plist_Bd_pi[1].p.absvalue(), plist_Bd_mu[0].p.absvalue()
                    
                    D_K_En, D_pi1_En, D_pi2_En, D_mu_En = plist_Dst_D0[0].energy, plist_Dst_D0[1].energy, plist_Bd_pi[1].energy, plist_Bd_mu[0].energy
                                        
                    Dst_Kpipimu_En = D_K_En + D_pi1_En + D_pi2_En + D_mu_En
        
                    #Bd_Kpipimu_pt = np.dot([plist_Dst_D0[0].p.px + plist_Dst_D0[1].p.px + plist_Dst_D0[2].p.px + plist_Bd_mu[0].p.px + Bd_X_px, plist_Dst_D0[0].p.py + plist_Dst_D0[1].p.py + plist_Dst_D0[2].p.py + plist_Bd_mu[0].p.py + Bd_X_py, plist_Dst_D0[0].p.pz + plist_Dst_D0[1].p.pz + plist_Dst_D0[2].p.pz + plist_Bd_mu[0].p.pz + Bd_X_pz],[plist_Dst_D0[0].p.px + plist_Dst_D0[1].p.px + plist_Dst_D0[2].p.px + plist_Bd_mu[0].p.px + Bd_X_px, plist_Dst_D0[0].p.py + plist_Dst_D0[1].p.py + plist_Dst_D0[2].p.py + plist_Bd_mu[0].p.py + Bd_X_py, plist_Dst_D0[0].p.pz + plist_Dst_D0[1].p.pz + plist_Dst_D0[2].p.pz + plist_Bd_mu[0].p.pz + Bd_X_pz])
                    
                    Bd_Kpipimu_pt = np.dot([D_K_px + D_pi1_px + D_pi2_px + D_mu_px, D_K_py + D_pi1_py + D_pi2_py + D_mu_py, D_K_pz + D_pi1_pz + D_pi2_pz + D_mu_pz],[D_K_px + D_pi1_px + D_pi2_px + D_mu_px, D_K_py + D_pi1_py + D_pi2_py + D_mu_py, D_K_pz + D_pi1_pz + D_pi2_pz + D_mu_pz])
                    
                    #Bd_Kpipimu_pt = np.dot([plist_Dst_D0[0].p.px + plist_Dst_D0[1].p.px + plist_Dst_D0[2].p.px + plist_Bd_mu[0].p.px + D_X_px, plist_Dst_D0[0].p.py + plist_Dst_D0[1].p.py + plist_Dst_D0[2].p.py + plist_Bd_mu[0].p.py + D_X_py, plist_Dst_D0[0].p.pz + plist_Dst_D0[1].p.pz + plist_Dst_D0[2].p.pz + plist_Bd_mu[0].p.pz + D_X_pz],[plist_Dst_D0[0].p.px + plist_Dst_D0[1].p.px + plist_Dst_D0[2].p.px + plist_Bd_mu[0].p.px + D_X_px, plist_Dst_D0[0].p.py + plist_Dst_D0[1].p.py + plist_Dst_D0[2].p.py + plist_Bd_mu[0].p.py + D_X_py, plist_Dst_D0[0].p.pz + plist_Dst_D0[1].p.pz + plist_Dst_D0[2].p.pz + plist_Bd_mu[0].p.pz + D_X_pz])
                    
                    Bd_KKpimuX_pt = np.dot([D_K_px + D_pi1_px + D_pi2_px + D_mu_px + Bd_X_px + D_X_px, D_K_py + D_pi1_py + D_pi2_py + D_mu_py + Bd_X_py + D_X_py, D_K_pz + D_pi1_pz + D_pi2_pz + D_mu_pz + Bd_X_pz + D_X_pz],[D_K_px + D_pi1_px + D_pi2_px + D_mu_px + Bd_X_px + D_X_px, D_K_py + D_pi1_py + D_pi2_py + D_mu_py + Bd_X_py + D_X_py, D_K_pz + D_pi1_pz + D_pi2_pz + D_mu_pz + Bd_X_pz + D_X_pz])
                    
                    Bd_Kpipimu_mass = np.sqrt((Dst_Kpipimu_En)**2 - Bd_Kpipimu_pt)
                    
                    #Bd_Kpipimu_mass = np.sqrt((Dst_Kpipimu_En + Bd_X_Et)**2 - Bd_Kpipimu_pt)
                    #Bd_Kpipimu_mass = np.sqrt((Dst_Kpipimu_En + D_X_Et)**2 - Bd_Kpipimu_pt)
                                        
                    Bd_KpipimuX_mass = np.sqrt((Dst_Kpipimu_En + Bd_X_Et)**2 - Bd_KKpimuX_pt)
        
                    D_K = copy.deepcopy(plist_Dst_D0[0])
                    D_pi1 = copy.deepcopy(plist_Dst_D0[1])
                    D_pi2 = copy.deepcopy(plist_Bd_pi[1])
                    D_mu  = copy.deepcopy(plist_Bd_mu[0])
                    
                    D_K_pT = np.sqrt(plist_Dst_D0[0].p.px**2 + plist_Dst_D0[0].p.py**2)
                    D_pi1_pT = np.sqrt(plist_Dst_D0[1].p.px**2 + plist_Dst_D0[1].p.py**2)
                    D_pi2_pT = np.sqrt(plist_Bd_pi[1].p.px**2 + plist_Bd_pi[1].p.py**2)
                    ...
                    Dst_Kpipi_spT = np.sqrt((D_K_spx + D_pi1_spx + D_pi2_spx)**2 + (D_K_spy + D_pi1_spy + D_pi2_spy)**2)
                    
                    Dst_Kpipi_sptot = np.dot([(D_K_spx + D_pi1_spx + D_pi2_spx),(D_K_spy + D_pi1_spy + D_pi2_spy), (D_K_spz + D_pi1_spz + D_pi2_spz)],[(D_K_spx + D_pi1_spx + D_pi2_spx),(D_K_spy + D_pi1_spy + D_pi2_spy), (D_K_spz + D_pi1_spz + D_pi2_spz)])

                    Dst_Kpipi_smass = np.sqrt((D_K_sEn + D_pi1_sEn + D_pi2_sEn)*(D_K_sEn + D_pi1_sEn + D_pi2_sEn) - Dst_Kpipi_sptot)
                    
                    Dst_Kpipimu_sEn = D_K_sEn + D_pi1_sEn + D_pi2_sEn + D_mu_sEn
                    
                    Bd_Kpipimu_spt = np.dot([D_K_spx + D_pi1_spx + D_pi2_spx + D_mu_spx, D_K_spy + D_pi1_spy + D_pi2_spy + D_mu_spy, D_K_spz + D_pi1_spz + D_pi2_spz + D_mu_spz],[D_K_spx + D_pi1_spx + D_pi2_spx + D_mu_spx, D_K_spy + D_pi1_spy + D_pi2_spy + D_mu_spy, D_K_spz + D_pi1_spz + D_pi2_spz + D_mu_spz])
                    
                    Bd_KpipimuX_spt = np.dot([D_K_spx + D_pi1_spx + D_pi2_spx + D_mu_spx + Bd_X_spx, D_K_spy + D_pi1_spy + D_pi2_spy + D_mu_spy + Bd_X_spy , D_K_spz + D_pi1_spz + D_pi2_spz + D_mu_spz + Bd_X_spz],[D_K_spx + D_pi1_spx + D_pi2_spx + D_mu_spx + Bd_X_spx, D_K_spy + D_pi1_spy + D_pi2_spy + D_mu_spy + Bd_X_spy , D_K_spz + D_pi1_spz + D_pi2_spz + D_mu_spz + Bd_X_spz])
                    
                    #Bd_KpipimuX_spt = np.dot([D_K_spx + D_pi1_spx + D_pi2_spx + D_mu_spx + Bd_X_spx + D_X_spx, D_K_spy + D_pi1_spy + D_pi2_spy + D_mu_spy + Bd_X_spy + D_X_spy, D_K_spz + D_pi1_spz + D_pi2_spz + D_mu_spz + Bd_X_spz + D_X_spz],[D_K_spx + D_pi1_spx + D_pi2_spx + D_mu_spx + Bd_X_spx + D_X_spx, D_K_spy + D_pi1_spy + D_pi2_spy + D_mu_spy + Bd_X_spy + D_X_spy, D_K_spz + D_pi1_spz + D_pi2_spz + D_mu_spz + Bd_X_spz + D_X_spz])
                    
                    #Bd_KpipimuX_spt = np.dot([D_K.p.px + D_pi1.p.px + D_pi2.p.px + D_mu.p.px, D_K.p.py + D_pi1.p.py + D_pi2.p.py + D_mu.p.py, D_K.p.pz + D_pi1.p.pz + D_pi2.p.pz + D_mu.p.pz],[D_K.p.px + D_pi1.p.px + D_pi2.p.px + D_mu.p.px, D_K.p.py + D_pi1.p.py + D_pi2.p.py + D_mu.p.py, D_K.p.pz + D_pi1.p.pz + D_pi2.p.pz + D_mu.p.pz])

                    Bd_Kpipimu_smass = np.sqrt((Dst_Kpipimu_sEn)**2 - Bd_Kpipimu_spt)
                    
                    Bd_KpipimuX_smass = np.sqrt((Dst_Kpipimu_sEn + Bd_X_sEt)**2 - Bd_KpipimuX_spt)
                    #Bd_KpipimuX_smass = np.sqrt(Dst_Kpipimu_sEn**2 - Bd_KpipimuX_spt)
                    ...
                    Dst_Kpipi_spx = D_K_spx + D_pi1_spx + D_pi2_spx
                    Dst_Kpipi_spy = D_K_spy + D_pi1_spy + D_pi2_spy
                    Dst_Kpipi_spz = D_K_spz + D_pi1_spz + D_pi2_spz
                    
                    Dst_Kpipi_sppar_FdB = np.dot([Dst_Kpipi_spx,Dst_Kpipi_spy,Dst_Kpipi_spz],[Fd_B[0],Fd_B[1],Fd_B[2]])*Fd_B
                    #Ds_KKpi_sppar_FdB = np.dot([Ds_KKpi_spx,Ds_KKpi_spy,Ds_KKpi_spz],[Fd_B[0],Fd_B[1],Fd_B[2]])
                    
                    Dst_Kpipi_spT_FdB = np.sqrt(np.dot([Dst_Kpipi_spx-Dst_Kpipi_sppar_FdB[0],Dst_Kpipi_spy-Dst_Kpipi_sppar_FdB[1],Dst_Kpipi_spz-Dst_Kpipi_sppar_FdB[2]],[Dst_Kpipi_spx-Dst_Kpipi_sppar_FdB[0],Dst_Kpipi_spy-Dst_Kpipi_sppar_FdB[1],Dst_Kpipi_spz-Dst_Kpipi_sppar_FdB[2]]))
                    
                    #================================================================================================
                                
                    Kpipimu_par = np.dot([sv_mctruth.x - pv_mctruth.x, sv_mctruth.y - pv_mctruth.y, sv_mctruth.z - pv_mctruth.z],[D_K_px + D_pi1_px + D_pi2_px + D_mu_px, D_K_py + D_pi1_py + D_pi2_py + D_mu_py, D_K_pz + D_pi1_pz + D_pi2_pz + D_mu_pz])/Bd_fd

                    Kpipimu_pTmis = np.dot([(D_K_px + D_pi1_px + D_pi2_px + D_mu_px) - Kpipimu_par*(sv_mctruth.x - pv_mctruth.x)/Bd_fd, (D_K_py + D_pi1_py + D_pi2_py + D_mu_py) - Kpipimu_par*(sv_mctruth.y - pv_mctruth.y)/Bd_fd, (D_K_pz + D_pi1_pz + D_pi2_pz + D_mu_pz) - Kpipimu_par*(sv_mctruth.z - pv_mctruth.z)/Bd_fd],[(D_K_px + D_pi1_px + D_pi2_px + D_mu_px) - Kpipimu_par*(sv_mctruth.x - pv_mctruth.x)/Bd_fd, (D_K_py + D_pi1_py + D_pi2_py + D_mu_py) - Kpipimu_par*(sv_mctruth.y - pv_mctruth.y)/Bd_fd, (D_K_pz + D_pi1_pz + D_pi2_pz + D_mu_pz) - Kpipimu_par*(sv_mctruth.z - pv_mctruth.z)/Bd_fd])
                    ...
                    Bd_Kpipimu_smcorr = np.sqrt(Bd_Kpipimu_smass**2 + Kpipimu_spTmis) + np.sqrt(Kpipimu_spTmis)
                    ...
                    self.mc_truth_tree.fill('B_KKpimu_mass',   Bd_Kpipimu_mass)
                    self.mc_truth_tree.fill('B_KKpimu_mcorr',  Bd_Kpipimu_mcorr)
                    ...
                    self.smeared_tree.fill('Dst_Kpipi_smass',    Dst_Kpipi_smass)
                    self.smeared_tree.fill('Dst_Kpipi_spT',      Dst_Kpipi_spT)
                    self.smeared_tree.fill('Dst_Kpipi_spT_FdB',  Dst_Kpipi_spT_FdB)
                    self.smeared_tree.fill('Kpipimu_spar',        Kpipimu_spar)
                    self.smeared_tree.fill('Kpipimu_spTmis',      np.sqrt(Kpipimu_spTmis))
                    self.smeared_tree.fill('B_KKpimu_smass',     Bd_Kpipimu_smass)
                    self.smeared_tree.fill('B_KKpimu_mcorr',     Bd_Kpipimu_mcorr)
                    self.smeared_tree.fill('B_KKpimu_smcorr',    Bd_Kpipimu_smcorr)
                    self.smeared_tree.fill('B_KKpimuX_mass',     Bd_KpipimuX_mass)
                    self.smeared_tree.fill('B_KKpimuX_smass',    Bd_KpipimuX_smass)
    ...
    def write(self, unusefulVar):
        ...
        print('D(+/-) from B0d: {}'.format(self.Dst_counter))
