...
class BdDstMuNuXKPiPiAnalyzer(Analyzer):
    def beginLoop(self, setup):
        ...
        super(BdDstMuNuXKPiPiAnalyzer, self).beginLoop(setup)
        #self.rootfile = TFile('/'.join([self.dirName, 'Bd2DmunuKpipi-100k.root']), 'recreate')
        
        self.rootfile = TFile('/'.join([self.dirName, 'Bd_DstmunuX_Kpipi_signal_evtpdl2019-1M.root']), 'recreate')
