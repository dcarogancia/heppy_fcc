...
class BdDDsXKKPiAnalyzer(Analyzer):
    def beginLoop(self, setup):
        ...
        super(BdDDsXKKPiAnalyzer, self).beginLoop(setup)
        #self.rootfile = TFile('/'.join([self.dirName, 'Bd2DmunuKpipi-100k.root']), 'recreate')
        #self.rootfile = TFile('/'.join([self.dirName, 'Bd_DDsbkgAnl-evtshp-500k.root']), 'recreate')
        #self.rootfile = TFile('/'.join([self.dirName, 'Bd_DDsbkgAnl_vtxfit-100k.root']), 'recreate')
        #self.rootfile = TFile('/'.join([self.dirName, 'Bd_DDsbkgAnl_vtxfit_bkg-100k.root']), 'recreate')
        #self.rootfile = TFile('/'.join([self.dirName, 'Bd_DDsbkgAnl_vtxfit_bkg_newevtgen-568k.root']), 'recreate')
        self.rootfile = TFile('/'.join([self.dirName, 'Bd_DDsX_KKpi_bkg_evtpdl2019-568k.root']), 'recreate')
            ...
            if (abs(ptc_gen.pdgid) == 511 and ptc_gen.start_vertex != ptc_gen.end_vertex):
                ...
                for ptc_gen1 in ptcs:   
                    ...
                    if (ptc_gen1.start_vertex == sv_mctruth):
                        ...
                        if abs(ptc_gen1.pdgid) not in [411,431,511]:
                ...
                #if len(plist_Bd_Ds) == 1 and len(plist_Bd_D) == 1 and len(plist_Bd_D2) == 0:
                #if len(plist_Bd_Ds) == 1 and len(plist_Bd_D) == 1 and self.DDs_counter < 568000:
                if len(plist_Bd_Ds) == 1 and len(plist_Bd_D) == 1 and self.DDs_counter < 568000:
                    ...
                    Bd_pt = np.dot([plist_Bd_Ds[0].p.px + plist_Bd_D[0].p.px + Bd_X_px, plist_Bd_Ds[0].p.py + plist_Bd_D[0].p.py + Bd_X_py, plist_Bd_Ds[0].p.pz + plist_Bd_D[0].p.pz + Bd_X_pz],[plist_Bd_Ds[0].p.px + plist_Bd_D[0].p.px + Bd_X_px, plist_Bd_Ds[0].p.py + plist_Bd_D[0].p.py + Bd_X_py, plist_Bd_Ds[0].p.pz + plist_Bd_D[0].p.pz + Bd_X_pz])
                    
                    
                    
                    Bd_mass = np.sqrt((Bd_Ds_En + plist_Bd_D[0].energy + Bd_X_Et)**2 - Bd_pt)                                     
                    
                    Bd_spt = np.dot([Bd_Ds.p.px + Bd_D.p.px + Bd_X_spx, Bd_Ds.p.py + Bd_D.p.py + Bd_X_spy, Bd_Ds.p.pz + Bd_D.p.pz + Bd_X_spz],[Bd_Ds.p.px + Bd_D.p.px + Bd_X_spx, Bd_Ds.p.py + Bd_D.p.py + Bd_X_spy, Bd_Ds.p.pz + Bd_D.p.pz + Bd_X_spz])
                    
                    Bd_Ds_sEn = np.sqrt(Bd_Ds.p.absvalue()**2 + Bd_Ds.mass**2)
                    
                    Bd_D_sEn = np.sqrt(Bd_D.p.absvalue()**2 + Bd_D.mass**2)
                
                    Bd_smass = np.sqrt((Bd_Ds_sEn + Bd_D_sEn + Bd_X_sEt)**2 - Bd_spt)
                    ...
                    #print plist_Ds_KKpi[0].pdgid, plist_Ds_KKpi[1].pdgid, plist_Ds_KKpi[2].pdgid 
                    ...
                    D_mu_px, D_mu_py, D_mu_pz = plist_D_mu[0].p.px, plist_D_mu[0].p.py, plist_D_mu[0].p.pz
                    
                    Ds_K1_p, Ds_K2_p, Ds_pi_p, D_mu_p = plist_Ds_KKpi[0].p.absvalue(), plist_Ds_KKpi[0].p.absvalue(), plist_Ds_KKpi[0].p.absvalue(), plist_D_mu[0].p.absvalue()
                    
                    Ds_K1_En, Ds_K2_En, Ds_pi_En, D_mu_En = plist_Ds_KKpi[0].energy, plist_Ds_KKpi[1].energy, plist_Ds_KKpi[2].energy, plist_D_mu[0].energy
                                        
                    Ds_KKpimu_En = Ds_K1_En + Ds_K2_En + Ds_pi_En + D_mu_En
                    
                    #Bd_KKpimu_pt = np.dot([plist_Ds_KKpi[0].p.px + plist_Ds_KKpi[1].p.px + plist_Ds_KKpi[2].p.px + plist_D_mu[0].p.px + Bd_X_px, plist_Ds_KKpi[0].p.py + plist_Ds_KKpi[1].p.py + plist_Ds_KKpi[2].p.py + plist_D_mu[0].p.py + Bd_X_py, plist_Ds_KKpi[0].p.pz + plist_Ds_KKpi[1].p.pz + plist_Ds_KKpi[2].p.pz + plist_D_mu[0].p.pz + Bd_X_pz],[plist_Ds_KKpi[0].p.px + plist_Ds_KKpi[1].p.px + plist_Ds_KKpi[2].p.px + plist_D_mu[0].p.px + Bd_X_px, plist_Ds_KKpi[0].p.py + plist_Ds_KKpi[1].p.py + plist_Ds_KKpi[2].p.py + plist_D_mu[0].p.py + Bd_X_py, plist_Ds_KKpi[0].p.pz + plist_Ds_KKpi[1].p.pz + plist_Ds_KKpi[2].p.pz + plist_D_mu[0].p.pz + Bd_X_pz])
                    ...
                    #Bd_KKpimu_pt = np.dot([plist_Ds_KKpi[0].p.px + plist_Ds_KKpi[1].p.px + plist_Ds_KKpi[2].p.px + plist_D_mu[0].p.px + D_X_px, plist_Ds_KKpi[0].p.py + plist_Ds_KKpi[1].p.py + plist_Ds_KKpi[2].p.py + plist_D_mu[0].p.py + D_X_py, plist_Ds_KKpi[0].p.pz + plist_Ds_KKpi[1].p.pz + plist_Ds_KKpi[2].p.pz + plist_D_mu[0].p.pz + D_X_pz],[plist_Ds_KKpi[0].p.px + plist_Ds_KKpi[1].p.px + plist_Ds_KKpi[2].p.px + plist_D_mu[0].p.px + D_X_px, plist_Ds_KKpi[0].p.py + plist_Ds_KKpi[1].p.py + plist_Ds_KKpi[2].p.py + plist_D_mu[0].p.py + D_X_py, plist_Ds_KKpi[0].p.pz + plist_Ds_KKpi[1].p.pz + plist_Ds_KKpi[2].p.pz + plist_D_mu[0].p.pz + D_X_pz])
                    ...
                    D_mu  = copy.deepcopy(plist_D_mu[0])
                    ...
                    D_mu_pT  = np.sqrt(plist_D_mu[0].p.px**2 + plist_D_mu[0].p.py**2)
                    ...
                    #============Muon/D meson momentum wrt B flight direction=====================================
                    ...
                    #Ds_KKpi_sppar_B = np.dot([Fd_B[0],Fd_B[1],Fd_B[2]],[Ds_KKpi_spx,Ds_KKpi_spy,Ds_KKpi_spz])
                    
                    #Ds_KKpi_spT_FdB = np.sqrt(np.dot([Ds_KKpi_spx-Ds_KKpi_sppar_B*Fd_B[0],Ds_KKpi_spy-Ds_KKpi_sppar_B*Fd_B[1],Ds_KKpi_spz-Ds_KKpi_sppar_B*Fd_B[2]],[Ds_KKpi_spx-Ds_KKpi_sppar_B*Fd_B[0],Ds_KKpi_spy-Ds_KKpi_sppar_B*Fd_B[1],Ds_KKpi_spz-Ds_KKpi_sppar_B*Fd_B[2]]))
                    #================================================================================================
                                
                    KKpimu_par = np.dot([sv_mctruth.x - pv_mctruth.x, sv_mctruth.y - pv_mctruth.y, sv_mctruth.z - pv_mctruth.z],[Ds_K1_px + Ds_K2_px + Ds_pi_px + D_mu_px, Ds_K1_py + Ds_K2_py + Ds_pi_py + D_mu_py, Ds_K1_pz + Ds_K2_pz + Ds_pi_pz + D_mu_pz])/Bd_fd

                    KKpimu_pTmis = np.dot([(Ds_K1_px + Ds_K2_px + Ds_pi_px + D_mu_px) - KKpimu_par*(sv_mctruth.x - pv_mctruth.x)/Bd_fd, (Ds_K1_py + Ds_K2_py + Ds_pi_py + D_mu_py) - KKpimu_par*(sv_mctruth.y - pv_mctruth.y)/Bd_fd, (Ds_K1_pz + Ds_K2_pz + Ds_pi_pz + D_mu_pz) - KKpimu_par*(sv_mctruth.z - pv_mctruth.z)/Bd_fd],[(Ds_K1_px + Ds_K2_px + Ds_pi_px + D_mu_px) - KKpimu_par*(sv_mctruth.x - pv_mctruth.x)/Bd_fd, (Ds_K1_py + Ds_K2_py + Ds_pi_py + D_mu_py) - KKpimu_par*(sv_mctruth.y - pv_mctruth.y)/Bd_fd, (Ds_K1_pz + Ds_K2_pz + Ds_pi_pz + D_mu_pz) - KKpimu_par*(sv_mctruth.z - pv_mctruth.z)/Bd_fd])
    ...
    def write(self, unusefulVar):
        ...
        print('D(+/-)DsD(+/-) meson events: {}'.format(self.DDs_counter))   
