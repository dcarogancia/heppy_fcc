## Configuration script for signal (B0s -> Ds+ Ds- K*0) analyzer
...
input_component = cfg.Component('b2stt', files = ['/afs/cern.ch/work/a/ansemkiv/private/FCC/analysis/background_Bs2DsDsK_1k.root'])
