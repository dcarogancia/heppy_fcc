...
from heppy_fcc.analyzers.BackgroundBd2DsKTauNuWithDs2PiPiPiPiAnalyzer import BackgroundBd2DsKTauNuWithDs2PiPiPiPiAnalyzer

logging.basicConfig(level=logging.WARNING)

# input component
# several input components can be declared and added to the list of selected components
input_component = cfg.Component('FCC_progressive', files = ['/afs/cern.ch/work/a/ansemkiv/private/FCC/analysis/background_Bd2DsKTauNu_with_Ds2PiPiPiPi_4k.root'])
...
bgana = cfg.Analyzer(BackgroundBd2DsKTauNuWithDs2PiPiPiPiAnalyzer,
                     smear_momentum = True,
